...
| 7 | /complete-task Log Progress -- follow-up task auto-created in Unprocessed (correct title/source) | PASS |
| 8 | /complete-task on follow-up -- marked done, moved to Completed | PASS |
...
- `complete-task.md` Mark Done had no instruction to resolve memory entries for delegated tasks � added Step 4 delegation close-out
- `complete-task.md` Log Progress had no delegation-aware follow-up path � added Step 3 overdue check-in handler with correct title/source format
...
### TEST-DEL-031: Mark delegated task complete via /complete-task

**Setup**:
- TASKS.md has Q3 task: `Delegate to: Jordan M.`, check-in date today
- Memory entry exists for Jordan M.

**Action**: Run `/complete-task`, mark the task done
...
**Action**: Run `/complete-task`, log "still in progress"
...
6. Run `/complete-task` — log "still in progress"
7. Verify follow-up task created in Unprocessed
8. Run `/complete-task` on the follow-up — mark done
