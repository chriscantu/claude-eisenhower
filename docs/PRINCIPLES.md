...
- `skills/` holds 3 skills (core, memory-manager, skill-enhancer), each with `SKILL.md` and optional `references/`
...
**In this repo:**
- Core (platform-agnostic): `/intake`, `/plan-week`, `/prioritize`, `/complete-task`, `/delegate`, `/today`, `/review-week`, `/review-org`
