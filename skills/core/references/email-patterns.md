...
Pattern library for `/scan-email`. Used to detect and classify actionable emails from the configured account/inbox (see `config/email-config.md`) into the three action categories. All matching is case-insensitive.
